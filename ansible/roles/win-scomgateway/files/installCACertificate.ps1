...
${Url}="192.168.226.10"
#Import-Certificate -Path \\cisinfra.local\repository\resources\certificates\certnew.p7b

$CAServer="adc1.cisinfra.local"
$Url = "http://${CAServer}/certsrv/certnew.p7b?ReqId=CACert&Renewal=0&Enc=bin"
$DownloadPath = "C:\Temp\certnew.p7b"
...
Import-Certificate -Container Root -Path .\certnew.p7b
