...
Write-Verbose "Creating sa-cloud user account"
$Computer = [ADSI]"WinNT://$Env:COMPUTERNAME,Computer"

$user = $computer.Create("User","sa-cloud")
$user.SetPassword("AS34#$hj@7")
$user.UserFlags = 64 + 65536
$user.setinfo()
$user.description = "sa-cloud"
$user.SetInfo()

$group = [ADSI]("WinNT://./Administrators,Group") 
$group.Add("WinNT://sa-cloud,user")
